...
return [
    ...
    */
    ...
    'project_name' => 'SecureGuard SaaS - Security Service Management',
    ...
    'project_logo' => '<i class="las la-shield-alt text-primary"></i> <strong class="text-dark">SecureGuard</strong> <small class="text-muted">SaaS Platform</small>',
    ...
    'developer_name' => 'SecureGuard Systems',
