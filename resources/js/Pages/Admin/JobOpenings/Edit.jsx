...
export default function Edit({ jobOpening }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        status: jobOpening.status || 'active',
        contact_email: jobOpening.contact_email || '',
        priority: jobOpening.priority || 1,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.job-openings.update', jobOpening.id));
    };

    return (
        <AdminLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Job Opening</h2>}
        >
                        ...
                        <div className="p-6 text-gray-900">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex justify-end gap-4">
                                    ...
                                    >
                                        {processing ? 'Updating...' : 'Update Job Opening'}
                                    </button>
                                </div>
                            </form>
                        </div>
