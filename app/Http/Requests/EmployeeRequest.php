...
class EmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'identity_proofs.*.document_type' => 'nullable|string|in:aadhar_card,pan_card,voter_id,driving_license,passport,bank_passbook,other',
            'identity_proofs.*.document_number' => 'nullable|string|max:255',
