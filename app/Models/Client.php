...
class Client extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        // Employee salary fields (for payroll calculation)
    ...
    /**
     * Get designation-wise rates for this client
     */
    public function designationRates(): HasMany
    {
        return $this->hasMany(ClientDesignationRate::class);
    }

    /**
     * Get rate for a specific designation
     */
    public function getRateForDesignation(string $designation): ?ClientDesignationRate
    {
        return $this->designationRates()->where('designation', $designation)->first();
    }
