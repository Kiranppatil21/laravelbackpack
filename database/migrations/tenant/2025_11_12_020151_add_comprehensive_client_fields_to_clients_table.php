...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('clients', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('clients', 'serial_no')) {
                $table->integer('serial_no')->nullable()->after('agency_id');
            }
            ...
            if (!Schema::hasColumn('clients', 'password')) {
                $table->string('password')->nullable()->after('additional_charges_comment');
            }
            ...
            if (!Schema::hasColumn('clients', 'sms_bill_reminder')) {
                $table->boolean('sms_bill_reminder')->default(false)->after('sms_bill');
            }
            if (!Schema::hasColumn('clients', 'sms_payment_receipt')) {
                $table->boolean('sms_payment_receipt')->default(false)->after('sms_bill_reminder');
            }
            if (!Schema::hasColumn('clients', 'email_reports')) {
                $table->boolean('email_reports')->default(false)->after('sms_payment_receipt');
            }
    ...
    public function down(): void
    {
        Schema::table('clients', function (Blueprint $table) {
            $table->dropColumn([
                'serial_no', 'name_of_client', 'to_title', 'site_name', 'address',
                ...
                'additional_charges', 'additional_charges_comment', 'password', 'status',
                'sms_reports', 'sms_attendance', 'sms_bill', 'sms_bill_reminder',
                'sms_payment_receipt', 'email_reports', 'email_attendance',
