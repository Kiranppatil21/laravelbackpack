...
// Agency name suggestions used by admin create form Select2 AJAX
use App\Http\Controllers\Admin\AgencyCrudController as AdminAgencyCrudController;
Route::get('admin/agency/name-suggestions', [AdminAgencyCrudController::class, 'nameSuggestions']);
// Activate / Deactivate agencies (POST) - super-admin only (policy before hook)
Route::post('admin/agency/{id}/activate', [AdminAgencyCrudController::class, 'activate']);
Route::post('admin/agency/{id}/deactivate', [AdminAgencyCrudController::class, 'deactivate']);
